...
//    signatureView = [[EasySignatureView alloc] initWithFrame:CGRectMake(0,46, ScreenWidth, SignatureViewHeight - 44 - 44)];
    signatureView = [[EasySignatureView alloc] initWithFrame:CGRectMake(0,46, ScreenWidth, SignatureViewHeight - 44 - 44)];
    NSLog(@"画布高：%f,宽：%f",signatureView.frame.size.height,signatureView.frame.size.width);
    ...
    UIButton *cancelBtn = [[UIButton alloc] initWithFrame:CGRectMake(6, 0, 80, 44)];
    [cancelBtn setTitle:@"写数字" forState:UIControlStateNormal];
    ...
    [btn3 setTitle:@"ok" forState:UIControlStateNormal];
